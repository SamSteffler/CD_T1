...
* 4B/5B (Visualizado com seu código base NRZ-I embutido)
...
* **Métricas:** Como pedido na atividade, ele mostra a quantidade de transições e o nível médio, calculados em tempo real com base na sequência de entrada fornecida.
